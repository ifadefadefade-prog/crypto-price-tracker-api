...
async def get_tokens_admin(
    ...
    symbols: Optional[List[str]] = Query(
        None,
        description="Filter by token symbols"
    ),
    chains: Optional[List[str]] = Query(
        None,
        description="Filter by blockchain networks"
    ),
    cex_symbols: Optional[List[str]] = Query(
        None,
        description="Filter by CEX symbols"
    ),
    addresses: Optional[List[str]] = Query(
        None,
        description="Filter by token addresses"
    ),
    created_after: Optional[datetime] = Query(
        None,
        description="Return tokens created after this datetime"
    ),
    created_before: Optional[datetime] = Query(
        None,
        description="Return tokens created before this datetime"
    ),
    limit: int = Query(
        50,
        ge=1,
